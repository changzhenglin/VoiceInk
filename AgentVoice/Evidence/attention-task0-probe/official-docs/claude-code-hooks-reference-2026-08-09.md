...
[Skip to main content](about:blank#content-area)
...
](/docs/en/agents)[Administration

](/docs/en/admin-setup)[Configuration

](/docs/en/settings)[Reference

](/docs/en/cli-reference)[Agent SDK

](/docs/en/agent-sdk/overview)[What's New

](/docs/en/whats-new)[Resources
...
- [Hook lifecycle](about:blank#hook-lifecycle)
	- [How a hook resolves](about:blank#how-a-hook-resolves)
- [Configuration](about:blank#configuration)
	- [Hook locations](about:blank#hook-locations)
		- [Matcher patterns](about:blank#matcher-patterns)
		- [Match MCP tools](about:blank#match-mcp-tools)
		- [Hook handler fields](about:blank#hook-handler-fields)
		- [Common fields](about:blank#common-fields)
		- [Command hook fields](about:blank#command-hook-fields)
		- [HTTP hook fields](about:blank#http-hook-fields)
		- [MCP tool hook fields](about:blank#mcp-tool-hook-fields)
		- [Prompt and agent hook fields](about:blank#prompt-and-agent-hook-fields)
		- [Reference scripts by path](about:blank#reference-scripts-by-path)
		- [Hooks in skills and agents](about:blank#hooks-in-skills-and-agents)
		- [The /hooks menu](about:blank#the-%2Fhooks-menu)
		- [Disable or remove hooks](about:blank#disable-or-remove-hooks)
- [Hook input and output](about:blank#hook-input-and-output)
	- [Common input fields](about:blank#common-input-fields)
		- [Exit code output](about:blank#exit-code-output)
		- [Exit code 2 behavior per event](about:blank#exit-code-2-behavior-per-event)
		- [HTTP response handling](about:blank#http-response-handling)
		- [JSON output](about:blank#json-output)
		- [Emit terminal notifications](about:blank#emit-terminal-notifications)
		- [Add context for Claude](about:blank#add-context-for-claude)
		- [Decision control](about:blank#decision-control)
- [Hook events](about:blank#hook-events)
	- [SessionStart](about:blank#sessionstart)
		- [SessionStart input](about:blank#sessionstart-input)
		- [SessionStart decision control](about:blank#sessionstart-decision-control)
		- [Persist environment variables](about:blank#persist-environment-variables)
		- [Setup](about:blank#setup)
		- [Setup input](about:blank#setup-input)
		- [Setup decision control](about:blank#setup-decision-control)
		- [InstructionsLoaded](about:blank#instructionsloaded)
		- [InstructionsLoaded input](about:blank#instructionsloaded-input)
		- [InstructionsLoaded decision control](about:blank#instructionsloaded-decision-control)
		- [UserPromptSubmit](about:blank#userpromptsubmit)
		- [UserPromptSubmit input](about:blank#userpromptsubmit-input)
		- [UserPromptSubmit decision control](about:blank#userpromptsubmit-decision-control)
		- [UserPromptExpansion](about:blank#userpromptexpansion)
		- [UserPromptExpansion input](about:blank#userpromptexpansion-input)
		- [UserPromptExpansion decision control](about:blank#userpromptexpansion-decision-control)
		- [MessageDisplay](about:blank#messagedisplay)
		- [MessageDisplay input](about:blank#messagedisplay-input)
		- [MessageDisplay output](about:blank#messagedisplay-output)
		- [PreToolUse](about:blank#pretooluse)
		- [PreToolUse input](about:blank#pretooluse-input)
		- [PreToolUse decision control](about:blank#pretooluse-decision-control)
		- [Defer a tool call for later](about:blank#defer-a-tool-call-for-later)
		- [PermissionRequest](about:blank#permissionrequest)
		- [PermissionRequest input](about:blank#permissionrequest-input)
		- [PermissionRequest decision control](about:blank#permissionrequest-decision-control)
		- [Permission update entries](about:blank#permission-update-entries)
		- [PostToolUse](about:blank#posttooluse)
		- [PostToolUse input](about:blank#posttooluse-input)
		- [PostToolUse decision control](about:blank#posttooluse-decision-control)
		- [PostToolUseFailure](about:blank#posttoolusefailure)
		- [PostToolUseFailure input](about:blank#posttoolusefailure-input)
		- [PostToolUseFailure decision control](about:blank#posttoolusefailure-decision-control)
		- [PostToolBatch](about:blank#posttoolbatch)
		- [PostToolBatch input](about:blank#posttoolbatch-input)
		- [PostToolBatch decision control](about:blank#posttoolbatch-decision-control)
		- [PermissionDenied](about:blank#permissiondenied)
		- [PermissionDenied input](about:blank#permissiondenied-input)
		- [PermissionDenied decision control](about:blank#permissiondenied-decision-control)
		- [Notification](about:blank#notification)
		- [Notification input](about:blank#notification-input)
		- [SubagentStart](about:blank#subagentstart)
		- [SubagentStart input](about:blank#subagentstart-input)
		- [SubagentStop](about:blank#subagentstop)
		- [SubagentStop input](about:blank#subagentstop-input)
		- [TaskCreated](about:blank#taskcreated)
		- [TaskCreated input](about:blank#taskcreated-input)
		- [TaskCreated decision control](about:blank#taskcreated-decision-control)
		- [TaskCompleted](about:blank#taskcompleted)
		- [TaskCompleted input](about:blank#taskcompleted-input)
		- [TaskCompleted decision control](about:blank#taskcompleted-decision-control)
		- [Stop](about:blank#stop)
		- [Stop input](about:blank#stop-input)
		- [Stop decision control](about:blank#stop-decision-control)
		- [StopFailure](about:blank#stopfailure)
		- [StopFailure input](about:blank#stopfailure-input)
		- [TeammateIdle](about:blank#teammateidle)
		- [TeammateIdle input](about:blank#teammateidle-input)
		- [TeammateIdle decision control](about:blank#teammateidle-decision-control)
		- [ConfigChange](about:blank#configchange)
		- [ConfigChange input](about:blank#configchange-input)
		- [ConfigChange decision control](about:blank#configchange-decision-control)
		- [CwdChanged](about:blank#cwdchanged)
		- [CwdChanged input](about:blank#cwdchanged-input)
		- [CwdChanged output](about:blank#cwdchanged-output)
		- [DirectoryAdded](about:blank#directoryadded)
		- [DirectoryAdded input](about:blank#directoryadded-input)
		- [FileChanged](about:blank#filechanged)
		- [FileChanged input](about:blank#filechanged-input)
		- [FileChanged output](about:blank#filechanged-output)
		- [WorktreeCreate](about:blank#worktreecreate)
		- [WorktreeCreate input](about:blank#worktreecreate-input)
		- [WorktreeCreate output](about:blank#worktreecreate-output)
		- [WorktreeRemove](about:blank#worktreeremove)
		- [WorktreeRemove input](about:blank#worktreeremove-input)
		- [PreCompact](about:blank#precompact)
		- [PreCompact input](about:blank#precompact-input)
		- [PostCompact](about:blank#postcompact)
		- [PostCompact input](about:blank#postcompact-input)
		- [SessionEnd](about:blank#sessionend)
		- [SessionEnd input](about:blank#sessionend-input)
		- [Elicitation](about:blank#elicitation)
		- [Elicitation input](about:blank#elicitation-input)
		- [Elicitation output](about:blank#elicitation-output)
		- [ElicitationResult](about:blank#elicitationresult)
		- [ElicitationResult input](about:blank#elicitationresult-input)
		- [ElicitationResult output](about:blank#elicitationresult-output)
- [Prompt-based hooks](about:blank#prompt-based-hooks)
	- [How prompt-based hooks work](about:blank#how-prompt-based-hooks-work)
		- [Prompt hook configuration](about:blank#prompt-hook-configuration)
		- [Response schema](about:blank#response-schema)
		- [Check multiple conditions before stopping](about:blank#check-multiple-conditions-before-stopping)
- [Agent-based hooks](about:blank#agent-based-hooks)
	- [How agent hooks work](about:blank#how-agent-hooks-work)
		- [Agent hook configuration](about:blank#agent-hook-configuration)
- [Run hooks in the background](about:blank#run-hooks-in-the-background)
	- [Configure an async hook](about:blank#configure-an-async-hook)
		- [How async hooks execute](about:blank#how-async-hooks-execute)
		- [Run tests after file changes](about:blank#run-tests-after-file-changes)
		- [Limitations](about:blank#limitations)
- [Security considerations](about:blank#security-considerations)
	- [Disclaimer](about:blank#disclaimer)
		- [Security best practices](about:blank#security-best-practices)
- [Windows PowerShell tool](about:blank#windows-powershell-tool)
- [Debug hooks](about:blank#debug-hooks)
...
](about:blank#how-a-hook-resolves)
...
![Diagram of hook resolution: PreToolUse fires, the matcher checks for a Bash match, then the if condition checks for a Bash(rm *) match. If both match, the hook command runs and returns permissionDecision deny, so the tool call is blocked and Claude Code continues. If either check fails to match, the hook is skipped and the tool call is allowed to proceed.](https://mintcdn.com/claude-code/ikqp3_70mqIahteV/images/hook-resolution.svg?w=2500&fit=max&auto=format&n=ikqp3_70mqIahteV&q=85&s=db26001610e83e10ed811acd29a83156)![Diagram of hook resolution: PreToolUse fires, the matcher checks for a Bash match, then the if condition checks for a Bash(rm *) match. If both match, the hook command runs and returns permissionDecision deny, so the tool call is blocked and Claude Code continues. If either check fails to match, the hook is skipped and the tool call is allowed to proceed.](https://mintcdn.com/claude-code/_xqph1dUOslCOwsj/images/hook-resolution-dark.svg?w=2500&fit=max&auto=format&n=_xqph1dUOslCOwsj&q=85&s=291052e72b2447764c092be2053a4975)
...
The [Configuration](about:blank#configuration) section below documents the full schema, and each [hook event](about:blank#hook-events) section documents what input your command receives and what output it can return.

## 

[​

](about:blank#configuration)

Configuration

Hooks are defined in JSON settings files. The configuration has three levels of nesting:
1. Choose a [hook event](about:blank#hook-events) to respond to, like `PreToolUse` or `Stop`
2. Add a [matcher group](about:blank#matcher-patterns) to filter when it fires, like “only for the Bash tool”
3. Define one or more [hook handlers](about:blank#hook-handler-fields) to run when matched
See [How a hook resolves](about:blank#how-a-hook-resolves) above for a complete walkthrough with an annotated example.
...
Cloud sessions on [Claude Code on the web](/docs/en/claude-code-on-the-web) don’t read your local `~/.claude/settings.json`; hooks there come from the repo and from your organization’s server-managed settings. See [what carries over from your setup](about:/docs/en/cloud-environments#what-carries-over-from-your-setup) for which files reach a cloud session. For details on settings file resolution, see [settings](/docs/en/settings). Hooks from settings files, managed policy settings, and plugins also run inside [subagents](/docs/en/sub-agents). When a subagent calls a tool, tool events such as `PreToolUse` and `PostToolUse` fire the same configured hooks as in the main conversation, and the input carries the `agent_id` and `agent_type` [common input fields](about:blank#common-input-fields) that identify the subagent. Enterprise administrators can use `allowManagedHooksOnly` to block user, project, and plugin hooks. Hooks from plugins force-enabled in managed settings `enabledPlugins` are exempt. See [Hook configuration](about:/docs/en/settings#hook-configuration). Hook entries merge across settings levels rather than replacing each other: user, project, and local settings add their own hooks without removing managed ones, and the [`disableAllHooks`](about:blank#disable-or-remove-hooks) setting can’t disable managed hooks from outside managed settings. The [HTTP hook allowlists](about:/docs/en/settings#hook-configuration) apply to hooks from every source, including managed policy settings:
...
| `FileChanged` | literal filenames to watch (see [FileChanged](about:blank#filechanged)) | `.envrc\|.env` |
...
The matcher runs against a field from the [JSON input](about:blank#hook-input-and-output) that Claude Code sends to your hook on stdin. For tool events, that field is `tool_name`. Each [hook event](about:blank#hook-events) section lists the full set of matcher values and the input schema for that event. This example runs a linting script only when Claude writes or edits a file:
...
If you add a `matcher` field to an event without matcher support, it is silently ignored. For tool events, you can filter more narrowly by setting the [`if` field](about:blank#common-fields) on individual hook handlers. `if` uses [permission rule syntax](/docs/en/permissions) to match against the tool name and arguments together, so `"Bash(git *)"` runs when any subcommand of the Bash input matches `git *` and `"Edit(*.ts)"` runs only for TypeScript files.

#### 

[​

](about:blank#match-mcp-tools)
...
](about:blank#hook-handler-fields)
...
- **[Command hooks](about:blank#command-hook-fields)** (`type: "command"`): run a shell command. Your script receives the event’s [JSON input](about:blank#hook-input-and-output) on stdin and communicates results back through exit codes and stdout.
- **[HTTP hooks](about:blank#http-hook-fields)** (`type: "http"`): send the event’s JSON input as an HTTP POST request to a URL. The endpoint communicates results back through the response body using the same [JSON output format](about:blank#json-output) as command hooks.
- **[MCP tool hooks](about:blank#mcp-tool-hook-fields)** (`type: "mcp_tool"`): call a tool on an already-connected [MCP server](/docs/en/mcp). The tool’s text output is treated like command-hook stdout.
- **[Prompt hooks](about:blank#prompt-and-agent-hook-fields)** (`type: "prompt"`): send a prompt to a Claude model for single-turn evaluation. The model returns a yes/no decision as JSON. See [Prompt-based hooks](about:blank#prompt-based-hooks).
- **[Agent hooks](about:blank#prompt-and-agent-hook-fields)** (`type: "agent"`): spawn a subagent that can use tools like Read, Grep, and Glob to verify conditions before returning a decision. Agent hooks are experimental and may change. See [Agent-based hooks](about:blank#agent-based-hooks).
...
| `if` | no | Permission rule syntax to filter when this hook runs, such as `"Bash(git *)"` or `"Edit(*.ts)"`. The hook command only runs if the tool call matches the pattern. See the [Bash matching table](about:blank#bash-if-matching) below for how Bash patterns evaluate against subcommands, `$()`, and backticks. Only evaluated on tool events: `PreToolUse`, `PostToolUse`, `PostToolUseFailure`, `PermissionRequest`, and `PermissionDenied`. On other events, a hook with `if` set never runs. Uses the same syntax as [permission rules](/docs/en/permissions) |
| `timeout` | no | Seconds before canceling. Defaults: 600 for `command`, `http`, and `mcp_tool`; 30 for `prompt`; 60 for `agent`. [`UserPromptSubmit`](about:blank#userpromptsubmit) lowers the `command`, `http`, and `mcp_tool` default to 30, and [`MessageDisplay`](about:blank#messagedisplay) lowers it to 10. [`SessionEnd`](about:blank#sessionend) hooks share a 1.5-second budget; if your settings set a longer per-hook `timeout`, Claude Code raises the budget to match, up to 60 seconds |
| `statusMessage` | no | Custom spinner message displayed while the hook runs |
| `once` | no | If `true`, runs once per session then is removed. Only honored for hooks declared in [skill frontmatter](about:blank#hooks-in-skills-and-agents); ignored in settings files and agent frontmatter |
...
](about:blank#command-hook-fields)

Command hook fields

In addition to the [common fields](about:blank#common-fields), command hooks accept these fields:

| Field | Required | Description |
| --- | --- | --- |
| `command` | yes | Shell command to execute. With `args`, the executable to spawn directly. See [Exec form and shell form](about:blank#exec-form-and-shell-form) |
| `args` | no | Argument list. When present, `command` is resolved as an executable and spawned directly with `args` as the argument vector, with no shell involved. See [Exec form and shell form](about:blank#exec-form-and-shell-form) |
| `async` | no | If `true`, runs in the background without blocking. See [Run hooks in the background](about:blank#run-hooks-in-the-background) |
...
Both forms support the same [path placeholders](about:blank#reference-scripts-by-path), and both export them as the environment variables `CLAUDE_PROJECT_DIR`, `CLAUDE_PLUGIN_ROOT`, and `CLAUDE_PLUGIN_DATA` on the spawned process, so a script can read `process.env.CLAUDE_PLUGIN_ROOT` regardless of how it was launched. Plugin hooks additionally substitute [`${user_config.*}`](about:/docs/en/plugins-reference#user-configuration) values, in exec form only: the value is substituted into `command` and into each `args` element as a plain string, so no shell re-parses it. A shell-form plugin hook whose `command` references `${user_config.*}` fails with an [error](about:/docs/en/errors#plugin-command-references-user-config) instead of running. To use an option value from a shell-form hook, read the `$CLAUDE_PLUGIN_OPTION_<KEY>` environment variable, such as `$CLAUDE_PLUGIN_OPTION_WEBHOOK_URL` for a `webhook_url` option, or set `args` to switch the hook to exec form. Before v2.1.207, shell-form plugin hook commands also substituted `${user_config.*}`.
...
](about:blank#http-hook-fields)

HTTP hook fields

In addition to the [common fields](about:blank#common-fields), HTTP hooks accept these fields:
...
Claude Code sends the hook’s [JSON input](about:blank#hook-input-and-output) as the POST request body with `Content-Type: application/json`. The response body uses the same [JSON output format](about:blank#json-output) as command hooks. Error handling differs from command hooks; see [HTTP response handling](about:blank#http-response-handling). This example sends `PreToolUse` events to a local validation service, authenticating with a token from the `MY_TOKEN` environment variable:
...
](about:blank#prompt-and-agent-hook-fields)

Prompt and agent hook fields

In addition to the [common fields](about:blank#common-fields), prompt and agent hooks accept these fields:
...
](about:blank#reference-scripts-by-path)
...
- `${CLAUDE_PROJECT_DIR}`: the project root. Claude Code also sets this variable in the environment of [stdio MCP servers](about:/docs/en/mcp#option-3-add-a-local-stdio-server) and plugin LSP servers.
...
- `${CLAUDE_PLUGIN_DATA}`: the plugin’s [persistent data directory](about:/docs/en/plugins-reference#persistent-data-directory), for dependencies and state that should survive plugin updates.
Prefer [exec form](about:blank#exec-form-and-shell-form) for any hook that references a path placeholder. In shell form, wrap each placeholder in double quotes.
...
See the [plugin components reference](about:/docs/en/plugins-reference#hooks) for details on creating plugin hooks.

### 

[​

](about:blank#hooks-in-skills-and-agents)
...
Subagents use the same format in their YAML frontmatter. Frontmatter hooks in a project subagent run only after you accept the [workspace trust dialog](about:/docs/en/permissions#project-allow-rules-and-workspace-trust) for the folder the agent file came from; see [which scopes are exempt](about:/docs/en/sub-agents#hooks-in-subagent-frontmatter). Before v2.1.218, these hooks could run from folders you hadn’t trusted.

### 

[​

](about:blank#the-/hooks-menu)
...
](about:blank#disable-or-remove-hooks)
...
](about:blank#hook-input-and-output)

Hook input and output

Command hooks receive JSON data via stdin and communicate results through exit codes, stdout, and stderr. HTTP hooks receive the same JSON as the POST request body and communicate results through the HTTP response body. This section covers fields and behavior common to all events. Each event’s section under [Hook events](about:blank#hook-events) includes its specific input schema and decision control options. On macOS and Linux, command hooks run in their own session without a controlling terminal as of v2.1.139. The hook process and any child processes can’t open `/dev/tty` or send escape sequences directly to the Claude Code interface. Windows has no `/dev/tty`. To surface a message to the user on any platform, return [`systemMessage`](about:blank#json-output) in JSON output. To trigger a desktop notification, set a window title, or ring the bell, return [`terminalSequence`](about:blank#emit-terminal-notifications) instead.

### 

[​

](about:blank#common-input-fields)

Common input fields

Hook events receive these fields as JSON, in addition to event-specific fields documented in each [hook event](about:blank#hook-events) section. For command hooks, this JSON arrives via stdin. For HTTP hooks, it arrives as the POST request body.

| Field | Description |
| --- | --- |
| `session_id` | Current session identifier |
| `prompt_id` | UUID identifying the user prompt currently being processed. Matches the [`prompt.id` attribute on OpenTelemetry events](about:/docs/en/monitoring-usage#event-correlation-attributes), so you can correlate hook output with telemetry for a single prompt. Absent until the first user input. Requires Claude Code v2.1.196 or later |
| `transcript_path` | Path to conversation JSON. The transcript file is written asynchronously and may lag the in-memory conversation, so it may not yet include the current turn’s most recent messages when a hook fires. Hooks that need the final assistant text of the current turn should use `last_assistant_message` on [Stop](about:blank#stop) and [SubagentStop](about:blank#subagentstop) instead of reading the transcript |
| `cwd` | Current working directory when the hook is invoked |
| `permission_mode` | Current [permission mode](about:/docs/en/permissions#permission-modes): `"default"`, `"plan"`, `"acceptEdits"`, `"auto"`, `"dontAsk"`, or `"bypassPermissions"`. The mode labeled **Manual** arrives as `"default"`, never as `"manual"`, so scripts that match `"default"` keep working. Not all events receive this field. Check the JSON example in each [hook event](about:blank#hook-events) section |
| `effort` | Object with a `level` field holding the active [effort level](about:/docs/en/model-config#adjust-effort-level) for the turn: `"low"`, `"medium"`, `"high"`, `"xhigh"`, or `"max"`. If the requested model effort exceeds what the current model supports, this is the downgraded level the model actually used. Ultracode is not a distinct level and reports as `"xhigh"`. The object matches the [status line](about:/docs/en/statusline#available-data) `effort` field. Present for events that fire within a tool-use context, such as `PreToolUse`, `PostToolUse`, `Stop`, and `SubagentStop`, when the current model supports the effort parameter. The level is also available to hook commands and the Bash tool as the `$CLAUDE_EFFORT` environment variable. |
...
The `tool_name`, `tool_input`, and `tool_use_id` fields are event-specific. Each [hook event](about:blank#hook-events) section documents the additional fields for that event.

### 

[​

](about:blank#exit-code-output)

Exit code output

The exit code from your hook command tells Claude Code whether the action should proceed, be blocked, or be ignored. **Exit 0** means success. Claude Code parses stdout for [JSON output fields](about:blank#json-output). JSON output is only processed on exit 0. For most events, stdout is written to the debug log but not shown in the transcript. The exceptions are `UserPromptSubmit`, `UserPromptExpansion`, and `SessionStart`, where stdout is added as context that Claude can see and act on. Stderr from a hook that exits 0 goes to the debug log only, never the transcript, and Claude never sees it. To read it yourself, enable [debug logging](about:blank#debug-hooks). To surface a warning to Claude from a `PostToolUse` or `PostToolUseFailure` hook, exit 2 instead so [Claude sees the stderr](about:blank#exit-code-2-behavior-per-event) even though the tool already ran. **Exit 2** means a blocking error. Claude Code ignores stdout and any JSON in it. Instead, stderr text is fed back to Claude as an error message. The effect depends on the event: `PreToolUse` blocks the tool call, `UserPromptSubmit` rejects the prompt, and so on. See [exit code 2 behavior](about:blank#exit-code-2-behavior-per-event) for the full list. A hook that exits 2 while printing JSON that fails [JSON output](about:blank#json-output) schema validation still blocks: Claude Code uses stderr as the blocking reason and records the validation failure in the debug log. Before v2.1.214, Claude Code treated that combination as a non-blocking error and the action proceeded. **Any other exit code** is a non-blocking error for most hook events. The action proceeds, and the transcript shows a `<hook name> hook error` notice followed by the first line of stderr, prefixed with `Failed with non-blocking status code:`. To capture the full stderr, enable [debug logging](about:blank#debug-hooks). For example, a hook command script that blocks dangerous Bash commands:
...
](about:blank#exit-code-2-behavior-per-event)
...
- **2xx with a JSON body**: success, parsed using the same [JSON output](about:blank#json-output) schema as command hooks
...
](about:blank#json-output)

JSON output

Exit codes only let you block or stay silent, but JSON output gives you finer-grained control. Instead of exiting with code 2 to block, exit 0 and print a JSON object to stdout. Claude Code reads specific fields from that JSON to control behavior, including [decision control](about:blank#decision-control) for blocking, allowing, or escalating to the user.

You must choose one approach per hook, not both: either use exit codes alone for signaling, or exit 0 and print JSON for structured control. Claude Code only processes JSON on exit 0. If you exit 2, any JSON is ignored.

Your hook’s stdout must contain only the JSON object. If your shell profile prints text on startup, it can interfere with JSON parsing. See [JSON validation failed](about:/docs/en/hooks-guide#json-validation-failed) in the troubleshooting guide. Hook output strings, including `additionalContext`, `systemMessage`, and plain stdout, are capped at 10,000 characters. Output that exceeds this limit is saved to a file and replaced with a preview and file path, the same way a large valid Bash result is handled under [Output limits](about:/docs/en/tools-reference#output-limits). The JSON object supports three kinds of fields:
...
](about:blank#emit-terminal-notifications)
...
](about:blank#add-context-for-claude)
...
- [SessionStart](about:blank#sessionstart), [Setup](about:blank#setup), and [SubagentStart](about:blank#subagentstart): at the start of the conversation, before the first prompt
- [UserPromptSubmit](about:blank#userpromptsubmit) and [UserPromptExpansion](about:blank#userpromptexpansion): alongside the submitted prompt
- [PreToolUse](about:blank#pretooluse), [PostToolUse](about:blank#posttooluse), [PostToolUseFailure](about:blank#posttoolusefailure), and [PostToolBatch](about:blank#posttoolbatch): next to the tool result
- [Stop](about:blank#stop) and [SubagentStop](about:blank#subagentstop): at the end of the turn. The conversation continues so Claude can act on the feedback. See [Stop decision control](about:blank#stop-decision-control)
...
| --- | --- | --- |
| UserPromptSubmit, UserPromptExpansion, PostToolUse, PostToolUseFailure, PostToolBatch, Stop, SubagentStop, ConfigChange, PreCompact | Top-level `decision` | `decision: "block"`, `reason`. Stop and SubagentStop also accept `hookSpecificOutput.additionalContext` for [non-error feedback that continues the conversation](about:blank#stop-decision-control) |
...
| SessionStart, Setup, SubagentStart | Context only | `hookSpecificOutput.additionalContext` adds context for Claude. SessionStart also accepts [`initialUserMessage`, `watchPaths`, `sessionTitle`, and `reloadSkills`](about:blank#sessionstart-decision-control). No blocking or decision control |
...
- `PreToolUse`: `updatedInput` directly under `hookSpecificOutput` replaces a tool’s arguments before it runs. See [PreToolUse decision control](about:blank#pretooluse-decision-control)
- `PermissionRequest`: `updatedInput` inside the `decision` object. See [PermissionRequest decision control](about:blank#permissionrequest-decision-control)
- `PostToolUse`: `updatedToolOutput` replaces the tool’s result. See [PostToolUse decision control](about:blank#posttooluse-decision-control)
...
Uses `hookSpecificOutput` for richer control: allow, deny, or escalate to the user. You can also modify tool input before it runs or inject additional context for Claude. See [PreToolUse decision control](about:blank#pretooluse-decision-control) for the full set of options.
...
Uses `hookSpecificOutput` to allow or deny a permission request on behalf of the user. When allowing, you can also modify the tool’s input or apply permission rules so the user isn’t prompted again. See [PermissionRequest decision control](about:blank#permissionrequest-decision-control) for the full set of options.
...
](about:blank#sessionstart-input)

SessionStart input

In addition to the [common input fields](about:blank#common-input-fields), SessionStart hooks receive `source` and optionally `model`, `agent_type`, and `session_title`:
...
](about:blank#sessionstart-decision-control)

SessionStart decision control

Any text your hook script prints to stdout is added as context for Claude. In addition to the [JSON output fields](about:blank#json-output) available to all hooks, you can return these event-specific fields:

| Field | Description |
| --- | --- |
| `additionalContext` | String added to Claude’s context at the start of the conversation, before the first prompt. See [Add context for Claude](about:blank#add-context-for-claude) for how the text is delivered and what to put in it |
...
| `watchPaths` | Array of absolute paths to watch for [FileChanged](about:blank#filechanged) events during this session |
...
](about:blank#persist-environment-variables)
...
`CLAUDE_ENV_FILE` is available for SessionStart, [Setup](about:blank#setup), [CwdChanged](about:blank#cwdchanged), and [FileChanged](about:blank#filechanged) hooks. Other hook types don’t have access to this variable.
...
](about:blank#setup-decision-control)

Setup decision control

Setup hooks can’t block. Any non-zero exit code, including 2, surfaces stderr to the user as a `<hook name> hook error` notice, and execution continues. In [non-interactive mode](/docs/en/headless), hook output appears only when you launch with `--verbose`. To pass information into Claude’s context, return `additionalContext` in JSON output; plain stdout is written to the debug log only. In addition to the [JSON output fields](about:blank#json-output) available to all hooks, you can return these event-specific fields:
...
Setup hooks have access to `CLAUDE_ENV_FILE`. Variables written to that file persist into subsequent Bash commands for the session, just as in [SessionStart hooks](about:blank#persist-environment-variables). Only `type: "command"` and `type: "mcp_tool"` hooks are supported.

### 

[​

](about:blank#instructionsloaded)
...
](about:blank#instructionsloaded-input)

InstructionsLoaded input

In addition to the [common input fields](about:blank#common-input-fields), InstructionsLoaded hooks receive these fields:
...
](about:blank#instructionsloaded-decision-control)
...
](about:blank#userpromptsubmit-input)

UserPromptSubmit input

In addition to the [common input fields](about:blank#common-input-fields), UserPromptSubmit hooks receive the `prompt` field containing the text the user submitted.
...
](about:blank#userpromptsubmit-decision-control)

UserPromptSubmit decision control

`UserPromptSubmit` hooks can control whether a user prompt is processed and add context. All [JSON output fields](about:blank#json-output) are available. There are two ways to add context to the conversation on exit code 0:
...
| `additionalContext` | String added to Claude’s context alongside the submitted prompt. See [Add context for Claude](about:blank#add-context-for-claude) |
...
](about:blank#userpromptexpansion)
...
](about:blank#userpromptexpansion-input)

UserPromptExpansion input

In addition to the [common input fields](about:blank#common-input-fields), UserPromptExpansion hooks receive `expansion_type`, `command_name`, `command_args`, `command_source`, and the original `prompt` string. The `expansion_type` field is `slash_command` for skill and custom commands, or `mcp_prompt` for MCP server prompts.
...
](about:blank#userpromptexpansion-decision-control)

UserPromptExpansion decision control

`UserPromptExpansion` hooks can block the expansion or add context. All [JSON output fields](about:blank#json-output) are available.
...
| `additionalContext` | String added to Claude’s context alongside the expanded prompt. See [Add context for Claude](about:blank#add-context-for-claude) |
...
](about:blank#messagedisplay-input)

MessageDisplay input

In addition to the [common input fields](about:blank#common-input-fields), MessageDisplay hooks receive identifiers for the turn and message, the position of this call within the message, and the new text in `delta`. Batch boundaries depend on how the text streams, so use `index` and `final` to track progress through a message rather than expecting lines to be grouped a particular way.
...
](about:blank#messagedisplay-output)

MessageDisplay output

In addition to the [JSON output fields](about:blank#json-output) available to all hooks, MessageDisplay hooks can return `displayContent` to replace the delta on screen:
...
Batches with no markdown pass through unchanged. If the script fails, for example because `jq` is missing, Claude Code displays the original text and notes the failure only in [debug output](about:blank#debug-hooks), not in the session.

### 

[​

](about:blank#pretooluse)

PreToolUse

Runs after Claude creates tool parameters and before processing the tool call. Matches on tool name: `Bash`, `PowerShell`, `Edit`, `Write`, `Read`, `Glob`, `Grep`, `Agent`, `WebFetch`, `WebSearch`, `AskUserQuestion`, `ExitPlanMode`, and any [MCP tool names](about:blank#match-mcp-tools).

PreToolUse runs only when Claude calls a tool. Files you [reference with `@` in your prompt](about:/docs/en/common-workflows#reference-files-and-directories) are added without any tool call: Claude Code inserts their contents while building the prompt, so no PreToolUse hook fires for them, including hooks matching `Read`. To block specific paths from `@` references, use a [`Read` deny rule](about:/docs/en/permissions#read-and-edit) instead.PreToolUse also doesn’t fire for [`EndConversation`](about:/docs/en/tools-reference#endconversation-tool-behavior).

Use [PreToolUse decision control](about:blank#pretooluse-decision-control) to allow, deny, ask, or defer the tool call. An [Agent SDK callback hook](/docs/en/agent-sdk/hooks) on `PreToolUse` that exceeds its timeout blocks the tool call, and Claude receives an error result naming the timeout. An explicit deny returned by another hook still takes precedence.

#### 

[​

](about:blank#pretooluse-input)

PreToolUse input

In addition to the [common input fields](about:blank#common-input-fields), PreToolUse hooks receive `tool_name`, `tool_input`, and `tool_use_id`. For the file tools `Write`, `Edit`, and `Read`, `tool_input.file_path` is always absolute:
...
| `timeout` | number | `120000` | Optional timeout in milliseconds. Values above the [maximum](about:/docs/en/tools-reference#bash-tool-behavior) are reduced to the maximum rather than rejected |
| `run_in_background` | boolean | `false` | Whether to run the command in background |

##### PowerShell

Executes PowerShell commands. See the [PowerShell tool](about:/docs/en/tools-reference#powershell-tool) for availability by platform. The fields match the Bash tool, with the command string in `command`:
...
](about:blank#pretooluse-decision-control)
...
| Field | Description |
| --- | --- |
| `permissionDecision` | `"allow"` skips the permission prompt, except for [tools that require user interaction](about:blank#pretooluse-decision-control) and connector tools [your organization set to `ask`](about:/docs/en/mcp#organization-controls-on-connector-tools). `"deny"` prevents the tool call. `"ask"` prompts the user to confirm. `"defer"` exits gracefully so the tool can be resumed later. [Deny and ask rules](about:/docs/en/permissions#manage-permissions) are still evaluated regardless of what the hook returns |
...
| `additionalContext` | String added to Claude’s context alongside the tool result. Ignored when `permissionDecision` is `"defer"`. See [Add context for Claude](about:blank#add-context-for-claude) |
...
](about:blank#defer-a-tool-call-for-later)
...
](about:blank#permissionrequest-decision-control)

PermissionRequest decision control

`PermissionRequest` hooks can allow or deny permission requests. In addition to the [JSON output fields](about:blank#json-output) available to all hooks, your hook script can return a `decision` object with these event-specific fields:

| Field | Description |
| --- | --- |
| `behavior` | `"allow"` grants the permission, `"deny"` denies it. [Deny and ask rules](about:/docs/en/permissions#manage-permissions) are still evaluated, so a hook returning `"allow"` doesn’t override a matching deny rule |
...
| `updatedPermissions` | For `"allow"` only: array of [permission update entries](about:blank#permission-update-entries) to apply, such as adding an allow rule or changing the session permission mode |
...
](about:blank#permission-update-entries)

Permission update entries

The `updatedPermissions` output field and the [`permission_suggestions` input field](about:blank#permissionrequest-input) both use the same array of entry objects. Each entry has a `type` that determines its other fields, and a `destination` that controls where the change is written.
...
`setMode` with `bypassPermissions` only takes effect if the session was launched with bypass mode already available: `--dangerously-skip-permissions`, `--permission-mode bypassPermissions`, `--allow-dangerously-skip-permissions`, or `permissions.defaultMode: "bypassPermissions"` in settings, and the mode is not disabled by [`permissions.disableBypassPermissionsMode`](about:/docs/en/permissions#managed-settings). Otherwise the update is a no-op. `bypassPermissions` is never persisted as `defaultMode` regardless of `destination`.
...
](about:blank#posttooluse-decision-control)

PostToolUse decision control

`PostToolUse` hooks can provide feedback to Claude after tool execution. In addition to the [JSON output fields](about:blank#json-output) available to all hooks, your hook script can return these event-specific fields:
...
| `additionalContext` | String added to Claude’s context alongside the tool result. See [Add context for Claude](about:blank#add-context-for-claude) |
...
| `updatedMCPToolOutput` | Replaces the output for [MCP tools](about:blank#match-mcp-tools) only. Prefer `updatedToolOutput`, which works for all tools |
...
](about:blank#posttoolusefailure-decision-control)

PostToolUseFailure decision control

`PostToolUseFailure` hooks can provide context to Claude after a tool failure. In addition to the [JSON output fields](about:blank#json-output) available to all hooks, your hook script can return these event-specific fields:

| Field | Description |
| --- | --- |
| `additionalContext` | String added to Claude’s context alongside the error. See [Add context for Claude](about:blank#add-context-for-claude) |
...
](about:blank#posttoolbatch-input)

PostToolBatch input

In addition to the [common input fields](about:blank#common-input-fields), PostToolBatch hooks receive `tool_calls`, an array describing every tool call in the batch:
...
](about:blank#posttoolbatch-decision-control)

PostToolBatch decision control

`PostToolBatch` hooks can inject context for Claude. In addition to the [JSON output fields](about:blank#json-output) available to all hooks, your hook script can return these event-specific fields:

| Field | Description |
| --- | --- |
| `additionalContext` | Context string injected once before the next model call. See [Add context for Claude](about:blank#add-context-for-claude) for delivery details, what to put in it, and how resumed sessions handle past values |
...
](about:blank#permissiondenied-input)

PermissionDenied input

In addition to the [common input fields](about:blank#common-input-fields), PermissionDenied hooks receive `tool_name`, `tool_input`, `tool_use_id`, and `reason`.
...
| Field | Description |
| --- | --- |
| `reason` | The denial reason: the fixed text `Blocked by classifier` in most sessions, or the classifier’s written explanation when the session’s classifier model provides one. See [Review denials](about:/docs/en/auto-mode-config#review-denials) |

#### 

[​

](about:blank#permissiondenied-decision-control)
...
](about:blank#notification-input)

Notification input

In addition to the [common input fields](about:blank#common-input-fields), Notification hooks receive `message` with the notification text, an optional `title`, and `notification_type` indicating which type fired.
...
Notification hooks can’t block or modify notifications. They are intended for side effects such as forwarding the notification to an external service. The [common JSON output fields](about:blank#json-output) such as `systemMessage` apply.

### 

[​

](about:blank#subagentstart)
...
](about:blank#subagentstart-input)

SubagentStart input

In addition to the [common input fields](about:blank#common-input-fields), SubagentStart hooks receive `agent_id` with the unique identifier for the subagent and `agent_type` with the agent name that the matcher filters on.
...
SubagentStart hooks can’t block subagent creation, but they can inject context into the subagent. In addition to the [JSON output fields](about:blank#json-output) available to all hooks, you can return:

| Field | Description |
| --- | --- |
| `additionalContext` | String added to the subagent’s context at the start of its conversation, before its first prompt. See [Add context for Claude](about:blank#add-context-for-claude) |
...
SubagentStop hooks use the same decision control format as [Stop hooks](about:blank#stop-decision-control), including `hookSpecificOutput.additionalContext` with `hookEventName` set to `"SubagentStop"`, for non-error feedback that keeps the subagent running. Returning `decision: "block"` with a `reason` keeps the subagent running and delivers `reason` to the subagent as its next instruction. To inject context into the parent session after a subagent returns, use a [`PostToolUse`](about:blank#posttooluse) hook on the `Agent` tool instead.

### 

[​

](about:blank#taskcreated)
...
](about:blank#taskcreated-input)

TaskCreated input

In addition to the [common input fields](about:blank#common-input-fields), TaskCreated hooks receive `task_id`, `task_subject`, and optionally `task_description`, `teammate_name`, and `team_name`.
...
](about:blank#taskcreated-decision-control)
...
](about:blank#taskcompleted-input)

TaskCompleted input

In addition to the [common input fields](about:blank#common-input-fields), TaskCompleted hooks receive `task_id`, `task_subject`, and optionally `task_description`, `teammate_name`, and `team_name`.
...
](about:blank#taskcompleted-decision-control)
...
Runs when the main Claude Code agent has finished responding. Does not run if the stoppage occurred due to a user interrupt. API errors fire [StopFailure](about:blank#stopfailure) instead.
...
](about:blank#stop-decision-control)

Stop decision control

`Stop` and `SubagentStop` hooks can control whether Claude continues. In addition to the [JSON output fields](about:blank#json-output) available to all hooks, your hook script can return these event-specific fields:
...
](about:blank#stopfailure)

StopFailure

Runs instead of [Stop](about:blank#stop) when the turn ends due to an API error. Output and exit code are ignored. Use this to log failures, send alerts, or take recovery actions when Claude can’t complete a response due to rate limits, authentication problems, or other API errors.

#### 

[​

](about:blank#stopfailure-input)

StopFailure input

In addition to the [common input fields](about:blank#common-input-fields), StopFailure hooks receive `error`, optional `error_details`, and optional `last_assistant_message`. The `error` field identifies the error type and is used for matcher filtering.
...
](about:blank#teammateidle-input)

TeammateIdle input

In addition to the [common input fields](about:blank#common-input-fields), TeammateIdle hooks receive `teammate_name` and `team_name`.
...
](about:blank#teammateidle-decision-control)
...
](about:blank#configchange-input)

ConfigChange input

In addition to the [common input fields](about:blank#common-input-fields), ConfigChange hooks receive `source` and optionally `file_path`. The `source` field indicates which configuration type changed, and `file_path` provides the path to the specific file that was modified.
...
](about:blank#configchange-decision-control)
...
](about:blank#cwdchanged)

CwdChanged

Runs when the working directory changes during a session, for example when Claude executes a `cd` command. Use this to react to directory changes: reload environment variables, activate project-specific toolchains, or run setup scripts automatically. Pairs with [FileChanged](about:blank#filechanged) for tools like [direnv](https://direnv.net/) that manage per-directory environment. CwdChanged hooks have access to `CLAUDE_ENV_FILE`. Variables written to that file persist into subsequent Bash commands for the session, just as in [SessionStart hooks](about:blank#persist-environment-variables). CwdChanged doesn’t support matchers and fires on every directory change.

#### 

[​

](about:blank#cwdchanged-input)

CwdChanged input

In addition to the [common input fields](about:blank#common-input-fields), CwdChanged hooks receive `old_cwd` and `new_cwd`.
...
](about:blank#cwdchanged-output)

CwdChanged output

In addition to the [JSON output fields](about:blank#json-output) available to all hooks, CwdChanged hooks can return `watchPaths` to dynamically set which file paths [FileChanged](about:blank#filechanged) watches:
...
- You pass a directory with the `--add-dir` startup flag; [SessionStart](about:blank#sessionstart) covers those directories
...
](about:blank#directoryadded-input)

DirectoryAdded input

In addition to the [common input fields](about:blank#common-input-fields), DirectoryAdded hooks receive `directory` and `source`.
...
- **Filter which hooks run**: when a watched file changes, the same value filters which hook groups run using the standard [matcher rules](about:blank#matcher-patterns) against the changed file’s basename.
FileChanged hooks have access to `CLAUDE_ENV_FILE`. Variables written to that file persist into subsequent Bash commands for the session, just as in [SessionStart hooks](about:blank#persist-environment-variables).

#### 

[​

](about:blank#filechanged-input)

FileChanged input

In addition to the [common input fields](about:blank#common-input-fields), FileChanged hooks receive `file_path` and `event`.
...
](about:blank#filechanged-output)

FileChanged output

In addition to the [JSON output fields](about:blank#json-output) available to all hooks, FileChanged hooks can return `watchPaths` to dynamically update which file paths are watched:
...
](about:blank#worktreecreate)

WorktreeCreate

Runs when a worktree is being created, whether from `claude --worktree`, from a [subagent using `isolation: "worktree"`](about:/docs/en/sub-agents#choose-the-subagent-scope), or for a [background session](about:/docs/en/agent-view#how-file-edits-are-isolated) that Claude Code isolates in its own worktree. By default Claude Code creates the isolated working copy with `git worktree`. Configuring a WorktreeCreate hook replaces that default git behavior, letting you use a different version control system like SVN, Perforce, or Mercurial. Because the hook replaces the default behavior entirely, [`.worktreeinclude`](about:/docs/en/worktrees#copy-gitignored-files-into-worktrees) is not processed. If you need to copy local configuration files like `.env` into the new worktree, do it inside your hook script. The hook must return the path to the created worktree directory. Claude Code uses this path as the working directory for the isolated session. See [WorktreeCreate output](about:blank#worktreecreate-output) for how each hook type returns the path. This example creates an SVN working copy and prints the path for Claude Code to use. Replace the repository URL with your own:
...
](about:blank#worktreecreate-input)

WorktreeCreate input

In addition to the [common input fields](about:blank#common-input-fields), WorktreeCreate hooks receive the `name` field. This is a slug identifier for the new worktree, either specified by the user or auto-generated, for example `bold-oak-a3f2`.
...
](about:blank#worktreecreate-output)
...
](about:blank#worktreeremove-input)

WorktreeRemove input

In addition to the [common input fields](about:blank#common-input-fields), WorktreeRemove hooks receive the `worktree_path` field, which is the absolute path to the worktree being removed.
...
](about:blank#precompact-input)

PreCompact input

In addition to the [common input fields](about:blank#common-input-fields), PreCompact hooks receive `trigger` and `custom_instructions`. For `manual`, `custom_instructions` contains what the user passes into `/compact`. For `auto`, `custom_instructions` is empty.
...
](about:blank#postcompact-input)

PostCompact input

In addition to the [common input fields](about:blank#common-input-fields), PostCompact hooks receive `trigger` and `compact_summary`. The `compact_summary` field contains the conversation summary generated by the compact operation.
...
](about:blank#sessionend-input)

SessionEnd input

In addition to the [common input fields](about:blank#common-input-fields), SessionEnd hooks receive a `reason` field indicating why the session ended. See the [reason table](about:blank#sessionend) above for all values.
...
](about:blank#elicitation-input)

Elicitation input

In addition to the [common input fields](about:blank#common-input-fields), Elicitation hooks receive `mcp_server_name`, `message`, and optional `mode`, `url`, `elicitation_id`, and `requested_schema` fields. For form-mode elicitation, the most common case:
...
](about:blank#elicitation-output)
...
](about:blank#elicitationresult-input)

ElicitationResult input

In addition to the [common input fields](about:blank#common-input-fields), ElicitationResult hooks receive `mcp_server_name`, `action`, and optional `mode`, `elicitation_id`, and `content` fields.
...
](about:blank#elicitationresult-output)
...
](about:blank#prompt-based-hooks)
...
](about:blank#how-prompt-based-hooks-work)
...
](about:blank#prompt-hook-configuration)
...
| `continueOnBlock` | no | When the prompt returns `ok: false`, feed the reason back to Claude and continue the turn instead of stopping. Default: `false`. Implemented as `continue: true` on the resulting `decision: "block"`. See [Response schema](about:blank#response-schema) for per-event behavior |

### 

[​

](about:blank#response-schema)
...
- `PermissionRequest`: `ok: false` has no effect. To deny an approval from a hook, use a [command hook](about:blank#command-hook-fields) returning `hookSpecificOutput.decision.behavior: "deny"`
- `PermissionDenied`: `ok: false` has no effect because the denial already happened. The only output this event reads is `hookSpecificOutput.retry`, which prompt and agent hooks can’t set. They run on this event, but their output is discarded. Use a [command hook](about:blank#command-hook-fields) to return `retry`
If you need finer control on any event, use a [command hook](about:blank#command-hook-fields) with the per-event fields described in [Decision control](about:blank#decision-control).

### 

[​

](about:blank#check-multiple-conditions-before-stopping)
...
](about:blank#agent-based-hooks)

Agent-based hooks

Agent hooks are experimental. Behavior and configuration may change in future releases. For production workflows, prefer [command hooks](about:blank#command-hook-fields).
...
](about:blank#how-agent-hooks-work)
...
](about:blank#agent-hook-configuration)

Agent hook configuration

Set `type` to `"agent"` and provide a `prompt` string. The configuration fields are the same as [prompt hooks](about:blank#prompt-hook-configuration), with a longer default timeout:
...
](about:blank#run-hooks-in-the-background)
...
](about:blank#configure-an-async-hook)
...
](about:blank#security-considerations)
...
](about:blank#security-best-practices)
...
](about:blank#windows-powershell-tool)
...
For more granular hook matching details, set `CLAUDE_CODE_DEBUG_LOG_LEVEL=verbose` to see additional log lines such as hook matcher counts and query matching. For troubleshooting common issues like hooks not firing, Stop hooks that keep blocking, or configuration errors, see [Limitations and troubleshooting](about:/docs/en/hooks-guide#limitations-and-troubleshooting) in the guide. For a broader diagnostic walkthrough covering `/context`, `/doctor`, and settings precedence, see [Debug your config](/docs/en/debug-your-config).
